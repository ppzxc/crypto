...
public class Aes256CbcPkcs7PaddingExecutionPlan {
  ...
  public SymmetricKey symmetricKey = SymmetricKeyFactory.bit256();
  ...
  public void setUp() throws RuntimeException {
    crypto = CryptoFactory.aes(symmetricKey.getKey().getBytes(StandardCharsets.UTF_8), transformationType, transformation, cryptoProvider, iv);
  }
}
