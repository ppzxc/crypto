...
class Aes256CbcPkcs5PaddingImplTest {

  @DisplayName("aes 256 로 초기화된 crypto 로 암/복호화 할 수 있다. 1")
  @Test
  void t0() throws CryptoException {
    // given
    AesCrypto given = CryptoFactory.aes(RandomBytes.giveMeOne(32), Transformation.AES_CBC_PKCS5PADDING);
  ...
  @DisplayName("aes 256 로 초기화된 crypto 로 암/복호화 할 수 있다. 2")
  @Test
  ...
  @DisplayName("aes 256 로 초기화된 crypto 로 암/복호화 할 수 있다. 3")
  @Test
  ...
  @DisplayName("aes 256 로 초기화된 crypto 로 암/복호화 할 수 있다. 4")
  @Test
  ...
  @DisplayName("aes 256 로 초기화된 crypto 로 암/복호화 할 수 있다. 5")
  @Test
  ...
  @DisplayName("aes 256 로 초기화된 crypto 로 암/복호화 할 수 있다. 6")
  @Test
  ...
  @DisplayName("aes 256 로 초기화된 crypto 로 암/복호화 할 수 있다. 7")
  @Test
  ...
  @DisplayName("aes 256 로 초기화된 crypto 로 암/복호화 할 수 있다. 8")
  @Test
  ...
  @DisplayName("aes 256 로 초기화된 crypto 로 암/복호화 할 수 있다. 9")
  @Test
  ...
  @DisplayName("aes 256 로 초기화된 crypto 로 암/복호화 할 수 있다. 10")
  @Test
